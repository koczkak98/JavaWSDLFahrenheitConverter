...
public class AFDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AFDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AFDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AFDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AFDDateTimeConverter dateTimeConverter = new AFDStandardDateTimeConverter();

    public AFDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AFDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AFDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!= String.class  )) {
                String xmlName=AFDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AFDExtendedSoapSerializationEnvelope.class);
    ...
    public static Object getXSDType(Object param)
    {
        ...
        String xmlName=AFDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
